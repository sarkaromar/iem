        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <!-- form -->
                    <?=form_open_multipart(site_url("admin_panel/do_edit_blog"), array("class" => "form-horizontal"))?>
                        <div class="box-body">
                            <!-- blog title -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control" name="desc" rows="15" placeholder="Write your description here...." required><?=$list[0]->desc?></textarea>
                                </div>
                            </div>
                            <!-- image -->
                            <div class="form-group">
                                ...
                                <div class="col col-lg-4">
                                    <img id="previewImg1" src="<?=base_url()?>assets/img/blog/<?=$list[0]->image?>" width="130px" />
                                    <script>
