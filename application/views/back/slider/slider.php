                    ...
                    <?php echo form_open_multipart(site_url("admin_panel/add_slider"), array("class" => "form-horizontal")) ?>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="Main Caption" name="main_cap" required>
                                </div>
                            </div>
                            <!-- sub cap -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="text" placeholder="Sub Caption" name="sub_cap" required>
                                </div>
                            </div>
                            <!-- image -->
                            <div class="form-group">
                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo base_url(); ?>assets/img/slider/<?php echo $list->image; ?>" alt="<?php echo $list->main_cap; ?>" width="120px" height="50px" >
                                    </td>
                                    <td>
