                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?= base_url() ?>assets/back/images/profile/<?php echo $this->back_user->info->avatar ?>" class="user-image" alt="<?php echo $this->back_user->info->avatar ?>">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        <img src="<?= base_url() ?>assets/back/images/profile/<?php echo $this->back_user->info->avatar ?>" class="img-circle" alt="User Image">
                                        <p>
